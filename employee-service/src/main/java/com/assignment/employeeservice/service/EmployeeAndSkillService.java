...
public class EmployeeAndSkillService {
                        ...
                        e -> {
                            if (!e) {
                                ...
                                try {
                                    ...
                                    producer.sendMessage(getJsonString(employeeDTOResponse));
                ...
                .map(data ->
                        {
                            ...
                            //employeeMessageProducer.sendMessage(response.toString());
                            try {
                                producer.sendMessage(getJsonString(response));
    ...
    public Flux<EmployeeDTO> findBySkill(SkillQuery query) {
